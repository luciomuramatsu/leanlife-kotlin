...
public class CadastroActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        screenView.putString(
                ...
                CadastroActivity.class.getSimpleName()
        );
        ...
        TextView fab = (TextView) findViewById(R.id.link_login);
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try
                        {
                            ...
                            {
                                Intent myIntent = new Intent(CadastroActivity.this, MainActivity.class);
                                startActivity(myIntent);
                                signOutFromGplus();
                                finish();
                            }
                            ...
                            {
                                Intent myIntent = new Intent(CadastroActivity.this, VideoActivity.class);
                                startActivity(myIntent);
                                signOutFromGplus();
                                finish();
                            }
    ...
    public void criauser()
    {
        ...
        EditText input3 = (EditText) findViewById(R.id.input_name);
        ...
        else if(email.equals("")||email.isEmpty()||!ValidaEmail(email))
        {
        ...
        progress = new ProgressDialog(this);
        progress.setTitle(getString(R.string.tut4_pos3));
        progress.setMessage(getString(R.string.cadastro_pos1));
        progress.show();
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest( Request.Method.POST, urlf+"create", new JSONObject(params),
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        {
                            e.printStackTrace();
                            fb.mensagemerro(getString(R.string.cadastro_pos6), getString(R.string.cadastro_pos7), ct1);
                        }
