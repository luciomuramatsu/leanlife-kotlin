 ...
 */
public class NivelAtividades extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nivelatividades);
        ...
        screenView.putString(
                ...
                NivelAtividades.class.getSimpleName()
        );
        mFirebaseAnalytics.logEvent(
                "entrou_nivelatividades",
                screenView
        );
        ...
        setTitle(getString(R.string.tab2_9));
