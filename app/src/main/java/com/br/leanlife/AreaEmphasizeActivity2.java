 ...
 */
public class AreaEmphasizeActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_areaemphasize2);
        ...
        screenView.putString(
                ...
                AreaEmphasizeActivity2.class.getSimpleName()
        );
        ...
        value = "0"; // or other values
        if(b != null)
        {
            value = b.getString("tipo");
            if(value.equals("0"))
            {
                setTitle(getString(R.string.area_9));
            }
            else if(value.equals("1"))
            {
                setTitle(getString(R.string.area_10));
            }
        ...
        fab2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(value.equals("0") && selecionados != 3)
                {
                    fb.mensagemerro(getString(R.string.step4b_5), getString(R.string.step4b_6), ct1);
                    return;
                }
                else if(value.equals("1") && (selecionados <= 0 || selecionados > 3))
                {
                    fb.mensagemerro(getString(R.string.step4b_5), getString(R.string.step4b_7), ct1);
                    return;
                }
                else
                {
                    ...
                    {
                        editor.putString("step5_3", strfinal);
                        editor.putString("step5_3b", strfinal2);
                    }
    ...
    public void inicia()
    {
        ...
        if(value.equals("1"))
        {
            step5_2 = preferences.getString("step5_3", "");
        }
