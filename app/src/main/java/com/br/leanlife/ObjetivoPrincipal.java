 ...
 */
public class ObjetivoPrincipal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_objetivoprinc);
        ...
        screenView.putString(
                ...
                ObjetivoPrincipal.class.getSimpleName()
        );
        mFirebaseAnalytics.logEvent(
                "entrou_objetivoprinc",
                screenView
        );

        setTitle(getString(R.string.tab2_8));
